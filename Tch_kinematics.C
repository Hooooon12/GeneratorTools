...
TString filename1 = "/data4/Users/jihkim/GeneratorTools/Hist/HNtype1_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_Vanderbilt_ptcut5_MuMu_M1000.root";
TString filename2 = "/data4/Users/jihkim/GeneratorTools/Hist/HNtype1_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_Vanderbilt_ptcut10_MuMu_M1000.root";
TString filename3 = "/data4/Users/jihkim/GeneratorTools/Hist/HNtype1_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_Vanderbilt_ptcut15_MuMu_M1000.root";
TString filename4 = "/data4/Users/jihkim/GeneratorTools/Hist/HNtype1_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_Vanderbilt_ptcut20_MuMu_M1000.root";
...
gSystem->Exec("mkdir -p Tch_kinematics/Vanderbilt");

vector<TString> histname;
//histname.push_back("gamma_l_pt");
//histname.push_back("gamma_l_eta");
histname.push_back("hard_l_pt");
histname.push_back("hard_l_eta");
...
TH1D* gpt1 = (TH1D*)f1->Get("hard_l_pt");
TH1D* gpt2 = (TH1D*)f2->Get("hard_l_pt");
TH1D* gpt3 = (TH1D*)f3->Get("hard_l_pt");
TH1D* gpt4 = (TH1D*)f4->Get("hard_l_pt");

TH1D* geta1 = (TH1D*)f1->Get("hard_l_eta");
TH1D* geta2 = (TH1D*)f2->Get("hard_l_eta");
TH1D* geta3 = (TH1D*)f3->Get("hard_l_eta");
TH1D* geta4 = (TH1D*)f4->Get("hard_l_eta");
...
TCanvas* c1_scale = new TCanvas("c1_scale_xsec","hard_l pt",200,350,700,650);
...
TH1D* gpt1_scale = (TH1D*)gpt1->Clone("hard_l_pt");
TH1D* gpt2_scale = (TH1D*)gpt2->Clone("hard_l_pt");
TH1D* gpt3_scale = (TH1D*)gpt3->Clone("hard_l_pt");
TH1D* gpt4_scale = (TH1D*)gpt4->Clone("hard_l_pt");
...
gpt1_scale->SetTitle("hard_l pt (Vanderbilt)");
gpt1_scale->SetStats(0);
gpt1_scale->Scale(2.29);
gpt1_scale->Rebin(10);
gpt1_scale->GetXaxis()->SetRangeUser(0,600);
gpt1_scale->SetLineColor(kRed);
gpt1_scale->SetLineWidth(2);
gpt1_scale->Draw("hist");

gpt2_scale->Scale(1.58);
gpt2_scale->Rebin(10);
gpt2_scale->SetLineColor(kOrange);
gpt2_scale->SetLineWidth(2);
gpt2_scale->Draw("same hist");

gpt3_scale->Scale(1.24);
gpt3_scale->Rebin(10);
gpt3_scale->SetLineColor(8);
gpt3_scale->SetLineWidth(2);
gpt3_scale->Draw("same hist");

gpt4_scale->Scale(0.997);
gpt4_scale->Rebin(10);
gpt4_scale->SetLineColor(kBlue);
gpt4_scale->SetLineWidth(2);
gpt4_scale->Draw("same hist");
...
geta1->SetTitle("hard_l eta (Vanderbilt)");
geta1->SetStats(0);
geta1->Scale(2.29);
geta1->GetYaxis()->SetRangeUser(0,1050);
geta1->SetLineColor(kRed);
geta1->SetLineWidth(2);
geta1->Draw("hist");
geta2->Scale(1.58);
...
hnpt1->Scale(2.29);
hnpt1->Rebin(10);
hnpt1->GetXaxis()->SetRangeUser(0,800);
hnpt1->SetTitle("HN pt (Vanderbilt)");
hnpt1->SetStats(0);
hnpt1->SetLineColor(kRed);
hnpt1->SetLineWidth(2);
hnpt1->Draw("hist");
...
hneta1->Scale(2.29);
hneta1->GetYaxis()->SetRangeUser(0,800);
hneta1->SetTitle("HN eta (Vanderbilt)");
hneta1->SetStats(0);
hneta1->SetLineColor(kRed);
hneta1->SetLineWidth(2);
hneta1->Draw("hist");
