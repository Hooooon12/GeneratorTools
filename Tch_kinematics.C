{
TString LO_filename1 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_MuMu_M300_325100.root";
TString LO_filename2 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_MuMu_M600_325100.root";
TString LO_filename3 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_MuMu_M1000_325100.root";
TString LO_filename4 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_MuMu_M1500_325100.root";
TString LO_filename5 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_LO_MuMu_M2000_325100.root";
...
TString NLO_filename1 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_NLO_MuMu_M300_325100.root";
TString NLO_filename2 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_NLO_MuMu_M600_325100.root";
TString NLO_filename3 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_NLO_MuMu_M1000_325100.root";
TString NLO_filename4 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_NLO_MuMu_M1500_325100.root";
TString NLO_filename5 = "/data9/Users/jihkim/GeneratorTools/Hist/HNtype1_Tch_MG_HeavyMajoranaNeutrino_SSDiLepton_Tchannel_NLO_MuMu_M2000_325100.root";
...
TH1D* hardqpt_L300 = (TH1D*)L300->Get("forward_parton1_pt");
TH1D* hardqeta_L300 = (TH1D*)L300->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_L300 = (TH1D*)L300->Get("(l0+q0)_m");
TH1D* dRWJ_L300 = (TH1D*)L300->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_L300 = (TH1D*)L300->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_L300 = (TH1D*)L300->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_L300 = (TH1D*)L300->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_L300 = (TH1D*)L300->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_L300 = (TH1D*)L300->Get("DeltaR(j1forwardparton)");
...
TH1D* hardqpt_L600 = (TH1D*)L600->Get("forward_parton1_pt");
TH1D* hardqeta_L600 = (TH1D*)L600->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_L600 = (TH1D*)L600->Get("(l0+q0)_m");
TH1D* dRWJ_L600 = (TH1D*)L600->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_L600 = (TH1D*)L600->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_L600 = (TH1D*)L600->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_L600 = (TH1D*)L600->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_L600 = (TH1D*)L600->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_L600 = (TH1D*)L600->Get("DeltaR(j1forwardparton)");
...
TH1D* hardqpt_L1000 = (TH1D*)L1000->Get("forward_parton1_pt");
TH1D* hardqeta_L1000 = (TH1D*)L1000->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_L1000 = (TH1D*)L1000->Get("(l0+q0)_m");
TH1D* dRWJ_L1000 = (TH1D*)L1000->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_L1000 = (TH1D*)L1000->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_L1000 = (TH1D*)L1000->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_L1000 = (TH1D*)L1000->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_L1000 = (TH1D*)L1000->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_L1000 = (TH1D*)L1000->Get("DeltaR(j1forwardparton)");
...
TH1D* hardqpt_N300 = (TH1D*)N300->Get("forward_parton1_pt");
TH1D* hardqeta_N300 = (TH1D*)N300->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_N300 = (TH1D*)N300->Get("(l0+q0)_m");
TH1D* dRWJ_N300 = (TH1D*)N300->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_N300 = (TH1D*)N300->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_N300 = (TH1D*)N300->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_N300 = (TH1D*)N300->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_N300 = (TH1D*)N300->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_N300 = (TH1D*)N300->Get("DeltaR(j1forwardparton)");
...
TH1D* hardqpt_N600 = (TH1D*)N600->Get("forward_parton1_pt");
TH1D* hardqeta_N600 = (TH1D*)N600->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_N600 = (TH1D*)N600->Get("(l0+q0)_m");
TH1D* dRWJ_N600 = (TH1D*)N600->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_N600 = (TH1D*)N600->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_N600 = (TH1D*)N600->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_N600 = (TH1D*)N600->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_N600 = (TH1D*)N600->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_N600 = (TH1D*)N600->Get("DeltaR(j1forwardparton)");
...
TH1D* hardqpt_N1000 = (TH1D*)N1000->Get("forward_parton1_pt");
TH1D* hardqeta_N1000 = (TH1D*)N1000->Get("forward_parton1_eta");
...
TH1D* ml1Wq1_N1000 = (TH1D*)N1000->Get("(l0+q0)_m");
TH1D* dRWJ_N1000 = (TH1D*)N1000->Get("DeltaR(Wfatjet)");
TH1D* dRq1J_N1000 = (TH1D*)N1000->Get("DeltaR(q0fatjet)");
TH1D* dRq2J_N1000 = (TH1D*)N1000->Get("DeltaR(q1fatjet)");
TH1D* dRq1forward_N1000 = (TH1D*)N1000->Get("DeltaR(q0forwardparton)");
TH1D* dRq2forward_N1000 = (TH1D*)N1000->Get("DeltaR(q1forwardparton)");
TH1D* dRj2forward_N1000 = (TH1D*)N1000->Get("DeltaR(j1forwardparton)");
...
c27 = new TCanvas("c27","forward_parton pt",470,130,700,650);
c28 = new TCanvas("c28","forward_parton eta",490,110,700,650);
...
c39 = new TCanvas("c39","m(l1q1)",460,190,700,650);
c40 = new TCanvas("c40","dR(WJ)",480,170,700,650);
c41 = new TCanvas("c41","dR(q1J)",500,150,700,650);
c42 = new TCanvas("c42","dR(q2J)",520,130,700,650);
c43 = new TCanvas("c43","dR(q1forward)",540,110,700,650);
c44 = new TCanvas("c44","dR(q2forward)",560,90,700,650);
c45 = new TCanvas("c45","dR(j2forward)",580,70,700,650);


if(c1){
c1->cd();

mlljj_L300->SetTitle("m(l_{1}l_{2}j_{1}j_{2}) #scale[0.8]{(NLO vs LO)}");
mlljj_L300->SetStats(0);
mlljj_L300->Rebin(100);
//mlljj_L300->GetXaxis()->SetRangeUser(0,300);
mlljj_L300->GetYaxis()->SetRangeUser(0,30000);
mlljj_L300->GetXaxis()->SetTitle("m(l_{1}l_{2}j_{1}j_{2})");
mlljj_L300->SetLineColor(kRed);
mlljj_L300->SetLineWidth(3);
mlljj_L300->SetLineStyle(7);
mlljj_L300->Draw("hist");
mlljj_L600->Scale(mlljj_L300->GetEntries()/mlljj_L600->Integral());
mlljj_L600->Rebin(100);
mlljj_L600->SetLineColor(kGreen+1);
mlljj_L600->SetLineWidth(3);
mlljj_L600->SetLineStyle(7);
mlljj_L600->Draw("same hist");
mlljj_L1000->Scale(mlljj_L300->GetEntries()/mlljj_L1000->Integral());
mlljj_L1000->Rebin(100);
...
mlljj_N300->Scale(mlljj_L300->GetEntries()/mlljj_N300->Integral());
mlljj_N300->Rebin(100);
mlljj_N300->SetLineColor(kRed);
mlljj_N300->SetLineWidth(2);
mlljj_N300->Draw("same hist");
mlljj_N600->Scale(mlljj_L300->GetEntries()/mlljj_N600->Integral());
mlljj_N600->Rebin(100);
mlljj_N600->SetLineColor(kGreen+1);
mlljj_N600->SetLineWidth(2);
mlljj_N600->Draw("same hist");
mlljj_N1000->Scale(mlljj_L300->GetEntries()/mlljj_N1000->Integral());
mlljj_N1000->Rebin(100);
...
mlljj_legend->AddEntry(mlljj_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
mlljj_legend->AddEntry(mlljj_L300,"#scale[0.9]{LO}","l");
mlljj_legend->AddEntry(mlljj_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
mlljj_legend->AddEntry(mlljj_L600,"#scale[0.9]{LO}","l");
mlljj_legend->AddEntry(mlljj_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
ml1jj_L300->SetTitle("m(l1jj) #scale[0.8]{(NLO vs LO)}");
...
ml1jj_legend->AddEntry(ml1jj_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
ml1jj_legend->AddEntry(ml1jj_L300,"#scale[0.9]{LO}","l");
ml1jj_legend->AddEntry(ml1jj_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
ml1jj_legend->AddEntry(ml1jj_L600,"#scale[0.9]{LO}","l");
ml1jj_legend->AddEntry(ml1jj_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
ml2jj_L300->SetTitle("m(l2jj) #scale[0.8]{(NLO vs LO)}");
...
ml2jj_legend->AddEntry(ml2jj_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
ml2jj_legend->AddEntry(ml2jj_L300,"#scale[0.9]{LO}","l");
ml2jj_legend->AddEntry(ml2jj_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
ml2jj_legend->AddEntry(ml2jj_L600,"#scale[0.9]{LO}","l");
ml2jj_legend->AddEntry(ml2jj_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
Npt_L300->SetTitle("N pt #scale[0.8]{(NLO vs LO)}");
Npt_L300->SetStats(0);
Npt_L300->Rebin(20);
...
Npt_L300->Draw("hist");
Npt_L600->Scale(Npt_L300->GetEntries()/Npt_L600->Integral());
Npt_L600->Rebin(20);
Npt_L600->SetLineColor(kGreen+1);
Npt_L600->SetLineWidth(3);
Npt_L600->SetLineStyle(7);
Npt_L600->Draw("same hist");
Npt_L1000->Scale(Npt_L300->GetEntries()/Npt_L1000->Integral());
Npt_L1000->Rebin(20);
...
Npt_N300->SetStats(0);
Npt_N300->Scale(Npt_L300->GetEntries()/Npt_N300->Integral());
Npt_N300->Rebin(20);
Npt_N300->SetLineColor(kRed);
Npt_N300->SetLineWidth(2);
Npt_N300->Draw("same hist");
Npt_N600->Scale(Npt_L300->GetEntries()/Npt_N600->Integral());
Npt_N600->Rebin(20);
Npt_N600->SetLineColor(kGreen+1);
Npt_N600->SetLineWidth(2);
Npt_N600->Draw("same hist");
Npt_N1000->Scale(Npt_L300->GetEntries()/Npt_N1000->Integral());
Npt_N1000->Rebin(20);
...
Neta_L300->SetTitle("N eta #scale[0.8]{(NLO vs LO)}");
...
Neta_L300->Draw("hist");
Neta_L600->Scale(Neta_L300->GetEntries()/Neta_L600->Integral());
Neta_L600->Rebin(2);
Neta_L600->SetLineColor(kGreen+1);
Neta_L600->SetLineWidth(3);
Neta_L600->SetLineStyle(7);
Neta_L600->Draw("same hist");
Neta_L1000->Scale(Neta_L300->GetEntries()/Neta_L1000->Integral());
Neta_L1000->Rebin(2);
...
Neta_N300->Scale(Neta_L300->GetEntries()/Neta_N300->Integral());
Neta_N300->Rebin(2);
Neta_N300->SetLineColor(kRed);
Neta_N300->SetLineWidth(2);
Neta_N300->Draw("same hist");
Neta_N600->Scale(Neta_L300->GetEntries()/Neta_N600->Integral());
Neta_N600->Rebin(2);
Neta_N600->SetLineColor(kGreen+1);
Neta_N600->SetLineWidth(2);
Neta_N600->Draw("same hist");
Neta_N1000->Scale(Neta_L300->GetEntries()/Neta_N1000->Integral());
Neta_N1000->Rebin(2);
...
Neta_legend->AddEntry(Neta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Neta_legend->AddEntry(Neta_L300,"#scale[0.9]{LO}","l");
Neta_legend->AddEntry(Neta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Neta_legend->AddEntry(Neta_L600,"#scale[0.9]{LO}","l");
Neta_legend->AddEntry(Neta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
Nen_L300->SetTitle("N energy #scale[0.8]{(NLO vs LO)}");
Nen_L300->SetStats(0);
Nen_L300->Rebin(50);
...
Nen_legend->AddEntry(Nen_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Nen_legend->AddEntry(Nen_L300,"#scale[0.9]{LO}","l");
Nen_legend->AddEntry(Nen_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Nen_legend->AddEntry(Nen_L600,"#scale[0.9]{LO}","l");
Nen_legend->AddEntry(Nen_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
Nlpt_L300->SetTitle("l_{N} pt #scale[0.8]{(NLO vs LO)}");
...
Nlpt_L300->Draw("hist");
Nlpt_L600->Scale(Nlpt_L300->GetEntries()/Nlpt_L600->Integral());
Nlpt_L600->Rebin(20);
Nlpt_L600->SetLineColor(kGreen+1);
Nlpt_L600->SetLineWidth(3);
Nlpt_L600->SetLineStyle(7);
Nlpt_L600->Draw("same hist");
Nlpt_L1000->Scale(Nlpt_L300->GetEntries()/Nlpt_L1000->Integral());
Nlpt_L1000->Rebin(20);
...
Nlpt_N300->Scale(Nlpt_L300->GetEntries()/Nlpt_N300->Integral());
Nlpt_N300->Rebin(20);
Nlpt_N300->SetLineColor(kRed);
Nlpt_N300->SetLineWidth(2);
Nlpt_N300->Draw("same hist");
Nlpt_N600->Scale(Nlpt_L300->GetEntries()/Nlpt_N600->Integral());
Nlpt_N600->Rebin(20);
Nlpt_N600->SetLineColor(kGreen+1);
Nlpt_N600->SetLineWidth(2);
Nlpt_N600->Draw("same hist");
Nlpt_N1000->Scale(Nlpt_L300->GetEntries()/Nlpt_N1000->Integral());
Nlpt_N1000->Rebin(20);
...
Nleta_L300->SetTitle("l_{N} #eta #scale[0.8]{(NLO vs LO)}");
...
Nleta_L600->Scale(Nleta_L300->GetEntries()/Nleta_L600->Integral());
Nleta_L600->Rebin(2);
Nleta_L600->SetLineColor(kGreen+1);
Nleta_L600->SetLineWidth(3);
Nleta_L600->SetLineStyle(7);
Nleta_L600->Draw("same hist");
Nleta_L1000->Scale(Nleta_L300->GetEntries()/Nleta_L1000->Integral());
Nleta_L1000->Rebin(2);
...
Nleta_N300->Scale(Nleta_L300->GetEntries()/Nleta_N300->Integral());
Nleta_N300->Rebin(2);
Nleta_N300->SetLineColor(kRed);
Nleta_N300->SetLineWidth(2);
Nleta_N300->Draw("same hist");
Nleta_N600->Scale(Nleta_L300->GetEntries()/Nleta_N600->Integral());
Nleta_N600->Rebin(2);
Nleta_N600->SetLineColor(kGreen+1);
Nleta_N600->SetLineWidth(2);
Nleta_N600->Draw("same hist");
Nleta_N1000->Scale(Nleta_L300->GetEntries()/Nleta_N1000->Integral());
Nleta_N1000->Rebin(2);
...
Nleta_legend->AddEntry(Nleta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Nleta_legend->AddEntry(Nleta_L300,"#scale[0.9]{LO}","l");
Nleta_legend->AddEntry(Nleta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Nleta_legend->AddEntry(Nleta_L600,"#scale[0.9]{LO}","l");
Nleta_legend->AddEntry(Nleta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W1pt_L300->SetTitle("W1 pt #scale[0.8]{(NLO vs LO)}");
...
W1pt_legend->AddEntry(W1pt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W1pt_legend->AddEntry(W1pt_L300,"#scale[0.9]{LO}","l");
W1pt_legend->AddEntry(W1pt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W1pt_legend->AddEntry(W1pt_L600,"#scale[0.9]{LO}","l");
W1pt_legend->AddEntry(W1pt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W1eta_L300->SetTitle("W1 eta #scale[0.8]{(NLO vs LO)}");
...
W1eta_legend->AddEntry(W1eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W1eta_legend->AddEntry(W1eta_L300,"#scale[0.9]{LO}","l");
W1eta_legend->AddEntry(W1eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W1eta_legend->AddEntry(W1eta_L600,"#scale[0.9]{LO}","l");
W1eta_legend->AddEntry(W1eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W1mass_L300->SetTitle("W1 mass #scale[0.8]{(NLO vs LO)}");
...
W1mass_legend->AddEntry(W1mass_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W1mass_legend->AddEntry(W1mass_L300,"#scale[0.9]{LO}","l");
W1mass_legend->AddEntry(W1mass_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W1mass_legend->AddEntry(W1mass_L600,"#scale[0.9]{LO}","l");
W1mass_legend->AddEntry(W1mass_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W1en_L300->SetTitle("W1 energy #scale[0.8]{(NLO vs LO)}");
...
W1en_legend->AddEntry(W1en_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W1en_legend->AddEntry(W1en_L300,"#scale[0.9]{LO}","l");
W1en_legend->AddEntry(W1en_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W1en_legend->AddEntry(W1en_L600,"#scale[0.9]{LO}","l");
W1en_legend->AddEntry(W1en_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
hardlpt_L300->SetTitle("l_{#gamma} pt #scale[0.8]{(NLO vs LO)}");
...
hardlpt_L600->Scale(hardlpt_L300->GetEntries()/hardlpt_L600->Integral());
...
hardlpt_L1000->Scale(hardlpt_L300->GetEntries()/hardlpt_L1000->Integral());
...
hardleta_L300->SetTitle("l_{#gamma} #eta #scale[0.8]{(NLO vs LO)}");
...
hardleta_L600->Scale(hardleta_L300->GetEntries()/hardleta_L600->Integral());
...
hardleta_L1000->Scale(hardleta_L300->GetEntries()/hardleta_L1000->Integral());
...
hardleta_legend->AddEntry(hardleta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
hardleta_legend->AddEntry(hardleta_L300,"#scale[0.9]{LO}","l");
hardleta_legend->AddEntry(hardleta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
hardleta_legend->AddEntry(hardleta_L600,"#scale[0.9]{LO}","l");
hardleta_legend->AddEntry(hardleta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
j1pt_N300->Scale(j1pt_L300->GetEntries()/j1pt_N300->Integral());
j1pt_N300->Rebin(20);
j1pt_N300->SetLineColor(kRed);
j1pt_N300->SetLineWidth(2);
j1pt_N300->Draw("same hist");
j1pt_N600->Scale(j1pt_L300->GetEntries()/j1pt_N600->Integral());
j1pt_N600->Rebin(20);
j1pt_N600->SetLineColor(kGreen+1);
j1pt_N600->SetLineWidth(2);
j1pt_N600->Draw("same hist");
j1pt_N1000->Scale(j1pt_L300->GetEntries()/j1pt_N1000->Integral());
j1pt_N1000->Rebin(20);
...
j1eta_N300->Scale(j1eta_L300->GetEntries()/j1eta_N300->Integral());
j1eta_N300->Rebin(2);
j1eta_N300->SetLineColor(kRed);
j1eta_N300->SetLineWidth(2);
j1eta_N300->Draw("same hist");
j1eta_N600->Scale(j1eta_L300->GetEntries()/j1eta_N600->Integral());
j1eta_N600->Rebin(2);
j1eta_N600->SetLineColor(kGreen+1);
j1eta_N600->SetLineWidth(2);
j1eta_N600->Draw("same hist");
j1eta_N1000->Scale(j1eta_L300->GetEntries()/j1eta_N1000->Integral());
j1eta_N1000->Rebin(2);
...
j1eta_legend->AddEntry(j1eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
j1eta_legend->AddEntry(j1eta_L300,"#scale[0.9]{LO}","l");
j1eta_legend->AddEntry(j1eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
j1eta_legend->AddEntry(j1eta_L600,"#scale[0.9]{LO}","l");
j1eta_legend->AddEntry(j1eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
j2pt_N300->Scale(j2pt_L300->GetEntries()/j2pt_N300->Integral());
j2pt_N300->Rebin(10);
j2pt_N300->SetLineColor(kRed);
j2pt_N300->SetLineWidth(2);
j2pt_N300->Draw("same hist");
j2pt_N600->Scale(j2pt_L300->GetEntries()/j2pt_N600->Integral());
j2pt_N600->Rebin(10);
j2pt_N600->SetLineColor(kGreen+1);
j2pt_N600->SetLineWidth(2);
j2pt_N600->Draw("same hist");
j2pt_N1000->Scale(j2pt_L300->GetEntries()/j2pt_N1000->Integral());
j2pt_N1000->Rebin(10);
...
j2eta_N300->Scale(j2eta_L300->GetEntries()/j2eta_N300->Integral());
j2eta_N300->Rebin(2);
j2eta_N300->SetLineColor(kRed);
j2eta_N300->SetLineWidth(2);
j2eta_N300->Draw("same hist");
j2eta_N600->Scale(j2eta_L300->GetEntries()/j2eta_N600->Integral());
j2eta_N600->Rebin(2);
j2eta_N600->SetLineColor(kGreen+1);
j2eta_N600->SetLineWidth(2);
j2eta_N600->Draw("same hist");
j2eta_N1000->Scale(j2eta_L300->GetEntries()/j2eta_N1000->Integral());
j2eta_N1000->Rebin(2);
...
j2eta_legend->AddEntry(j2eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
j2eta_legend->AddEntry(j2eta_L300,"#scale[0.9]{LO}","l");
j2eta_legend->AddEntry(j2eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
j2eta_legend->AddEntry(j2eta_L600,"#scale[0.9]{LO}","l");
j2eta_legend->AddEntry(j2eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
Jpt_L300->SetTitle("fatjet pt #scale[0.8]{(NLO vs LO)}");
Jpt_L300->SetStats(0);
Jpt_L300->Rebin(20);
Jpt_L300->GetXaxis()->SetRangeUser(0,800);
Jpt_L300->GetYaxis()->SetRangeUser(0,21000);
Jpt_L300->GetXaxis()->SetTitle("fatjet p_{T} [GeV]");
Jpt_L300->SetLineColor(kRed);
Jpt_L300->SetLineWidth(3);
Jpt_L300->SetLineStyle(7);
Jpt_L300->Draw("hist");
Jpt_L600->Scale(Jpt_L300->GetEntries()/Jpt_L600->Integral());
Jpt_L600->Rebin(20);
Jpt_L600->SetLineColor(kGreen+1);
Jpt_L600->SetLineWidth(3);
Jpt_L600->SetLineStyle(7);
Jpt_L600->Draw("same hist");
Jpt_L1000->Scale(Jpt_L300->GetEntries()/Jpt_L1000->Integral());
Jpt_L1000->Rebin(20);
...
Jpt_N300->SetStats(0);
Jpt_N300->Scale(Jpt_L300->GetEntries()/Jpt_N300->Integral());
Jpt_N300->Rebin(20);
Jpt_N300->SetLineColor(kRed);
Jpt_N300->SetLineWidth(2);
Jpt_N300->Draw("same hist");
Jpt_N600->Scale(Jpt_L300->GetEntries()/Jpt_N600->Integral());
Jpt_N600->Rebin(20);
Jpt_N600->SetLineColor(kGreen+1);
Jpt_N600->SetLineWidth(2);
Jpt_N600->Draw("same hist");
Jpt_N1000->Scale(Jpt_L300->GetEntries()/Jpt_N1000->Integral());
Jpt_N1000->Rebin(20);
Jpt_N1000->SetLineColor(kBlue);
Jpt_N1000->SetLineWidth(2);
Jpt_N1000->Draw("same hist");

double Jptdiff_300 = 100*(Jpt_N300->GetMean()-Jpt_L300->GetMean())/Jpt_L300->GetMean();
TString Jptdiff_300_t = Form("%f",Jptdiff_300);
double Jptdiff_600 = 100*(Jpt_N600->GetMean()-Jpt_L600->GetMean())/Jpt_L600->GetMean();
TString Jptdiff_600_t = Form("%f",Jptdiff_600);
double Jptdiff_1000 = 100*(Jpt_N1000->GetMean()-Jpt_L1000->GetMean())/Jpt_L1000->GetMean();
TString Jptdiff_1000_t = Form("%f",Jptdiff_1000);
TLegend* Jpt_legend = new TLegend(0.62,0.65,0.9,0.9);
Jpt_legend->AddEntry(Jpt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Jpt_legend->AddEntry(Jpt_L300,"#scale[0.9]{LO}","l");
Jpt_legend->AddEntry((TObject*)0,"#bf{mean p_{T}} diff : "+Jptdiff_300_t+"%","");
Jpt_legend->AddEntry(Jpt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Jpt_legend->AddEntry(Jpt_L600,"#scale[0.9]{LO}","l");
Jpt_legend->AddEntry((TObject*)0,"diff : "+Jptdiff_600_t+"%","");
Jpt_legend->AddEntry(Jpt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
Jpt_legend->AddEntry(Jpt_L1000,"#scale[0.9]{LO}","l");
Jpt_legend->AddEntry((TObject*)0,"diff : "+Jptdiff_1000_t+"%","");
Jpt_legend->Draw();
}
...
Jeta_L300->SetTitle("fatjet #eta #scale[0.8]{(NLO vs LO)}");
Jeta_L300->SetStats(0);
Jeta_L300->Rebin(2);
Jeta_L300->GetYaxis()->SetRangeUser(0,15000);
Jeta_L300->GetXaxis()->SetTitle("fatjet #eta");
Jeta_L300->SetLineColor(kRed);
Jeta_L300->SetLineWidth(3);
Jeta_L300->SetLineStyle(7);
Jeta_L300->Draw("hist");
Jeta_L600->Scale(Jeta_L300->GetEntries()/Jeta_L600->Integral());
Jeta_L600->Rebin(2);
Jeta_L600->SetLineColor(kGreen+1);
Jeta_L600->SetLineWidth(3);
Jeta_L600->SetLineStyle(7);
Jeta_L600->Draw("same hist");
Jeta_L1000->Scale(Jeta_L300->GetEntries()/Jeta_L1000->Integral());
Jeta_L1000->Rebin(2);
...
Jeta_N300->Scale(Jeta_L300->GetEntries()/Jeta_N300->Integral());
Jeta_N300->Rebin(2);
Jeta_N300->SetLineColor(kRed);
Jeta_N300->SetLineWidth(2);
Jeta_N300->Draw("same hist");
Jeta_N600->Scale(Jeta_L300->GetEntries()/Jeta_N600->Integral());
Jeta_N600->Rebin(2);
Jeta_N600->SetLineColor(kGreen+1);
Jeta_N600->SetLineWidth(2);
Jeta_N600->Draw("same hist");
Jeta_N1000->Scale(Jeta_L300->GetEntries()/Jeta_N1000->Integral());
Jeta_N1000->Rebin(2);
...
Jeta_legend->AddEntry(Jeta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Jeta_legend->AddEntry(Jeta_L300,"#scale[0.9]{LO}","l");
Jeta_legend->AddEntry(Jeta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Jeta_legend->AddEntry(Jeta_L600,"#scale[0.9]{LO}","l");
Jeta_legend->AddEntry(Jeta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
mJ_L300->SetTitle("fatjet mass #scale[0.8]{(NLO vs LO)}");
mJ_L300->SetStats(0);
mJ_L300->Rebin(5);
mJ_L300->GetXaxis()->SetRangeUser(0,140);
mJ_L300->GetYaxis()->SetRangeUser(0,22000);
mJ_L300->GetXaxis()->SetTitle("m_{fatjet} [GeV]");
mJ_L300->SetLineColor(kRed);
mJ_L300->SetLineWidth(3);
mJ_L300->SetLineStyle(7);
mJ_L300->Draw("hist");
mJ_L600->Scale(mJ_L300->GetEntries()/mJ_L600->Integral());
mJ_L600->Rebin(5);
mJ_L600->SetLineColor(kGreen+1);
mJ_L600->SetLineWidth(3);
mJ_L600->SetLineStyle(7);
mJ_L600->Draw("same hist");
mJ_L1000->Scale(mJ_L300->GetEntries()/mJ_L1000->Integral());
mJ_L1000->Rebin(5);
...
mJ_N300->SetStats(0);
mJ_N300->Scale(mJ_L300->GetEntries()/mJ_N300->Integral());
mJ_N300->Rebin(5);
mJ_N300->SetLineColor(kRed);
mJ_N300->SetLineWidth(2);
mJ_N300->Draw("same hist");
mJ_N600->Scale(mJ_L300->GetEntries()/mJ_N600->Integral());
mJ_N600->Rebin(5);
mJ_N600->SetLineColor(kGreen+1);
mJ_N600->SetLineWidth(2);
mJ_N600->Draw("same hist");
mJ_N1000->Scale(mJ_L300->GetEntries()/mJ_N1000->Integral());
mJ_N1000->Rebin(5);
...
mJ_legend->AddEntry(mJ_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
mJ_legend->AddEntry(mJ_L300,"#scale[0.9]{LO}","l");
mJ_legend->AddEntry(mJ_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
mJ_legend->AddEntry(mJ_L600,"#scale[0.9]{LO}","l");
mJ_legend->AddEntry(mJ_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
mjj_N300->SetStats(0);
mjj_N300->Scale(mjj_L300->GetEntries()/mjj_N300->Integral());
mjj_N300->Rebin(5);
mjj_N300->SetLineColor(kRed);
mjj_N300->SetLineWidth(2);
mjj_N300->Draw("same hist");
mjj_N600->Scale(mjj_L300->GetEntries()/mjj_N600->Integral());
mjj_N600->Rebin(5);
mjj_N600->SetLineColor(kGreen+1);
mjj_N600->SetLineWidth(2);
mjj_N600->Draw("same hist");
mjj_N1000->Scale(mjj_L300->GetEntries()/mjj_N1000->Integral());
mjj_N1000->Rebin(5);
...
mjj_legend->AddEntry(mjj_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
mjj_legend->AddEntry(mjj_L300,"#scale[0.9]{LO}","l");
mjj_legend->AddEntry(mjj_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
mjj_legend->AddEntry(mjj_L600,"#scale[0.9]{LO}","l");
mjj_legend->AddEntry(mjj_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
mllJ_L300->SetTitle("m(l_{1}l_{2}J) #scale[0.8]{(NLO vs LO)}");
mllJ_L300->SetStats(0);
mllJ_L300->Rebin(50);
//mllJ_L300->GetXaxis()->SetRangeUser(0,300);
mllJ_L300->GetYaxis()->SetRangeUser(0,20000);
mllJ_L300->GetXaxis()->SetTitle("m(l_{1}l_{2}J) [GeV]");
mllJ_L300->SetLineColor(kRed);
mllJ_L300->SetLineWidth(3);
mllJ_L300->SetLineStyle(7);
mllJ_L300->Draw("hist");
mllJ_L600->Scale(mllJ_L300->GetEntries()/mllJ_L600->Integral());
mllJ_L600->Rebin(50);
mllJ_L600->SetLineColor(kGreen+1);
mllJ_L600->SetLineWidth(3);
mllJ_L600->SetLineStyle(7);
mllJ_L600->Draw("same hist");
mllJ_L1000->Scale(mllJ_L300->GetEntries()/mllJ_L1000->Integral());
mllJ_L1000->Rebin(50);
...
mllJ_N300->Scale(mllJ_L300->GetEntries()/mllJ_N300->Integral());
mllJ_N300->Rebin(50);
mllJ_N300->SetLineColor(kRed);
mllJ_N300->SetLineWidth(2);
mllJ_N300->Draw("same hist");
mllJ_N600->Scale(mllJ_L300->GetEntries()/mllJ_N600->Integral());
mllJ_N600->Rebin(50);
mllJ_N600->SetLineColor(kGreen+1);
mllJ_N600->SetLineWidth(2);
mllJ_N600->Draw("same hist");
mllJ_N1000->Scale(mllJ_L300->GetEntries()/mllJ_N1000->Integral());
mllJ_N1000->Rebin(50);
...
mllJ_legend->AddEntry(mllJ_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
mllJ_legend->AddEntry(mllJ_L300,"#scale[0.9]{LO}","l");
mllJ_legend->AddEntry(mllJ_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
mllJ_legend->AddEntry(mllJ_L600,"#scale[0.9]{LO}","l");
mllJ_legend->AddEntry(mllJ_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
ml1J_L300->SetTitle("m(l_{1}J) #scale[0.8]{(NLO vs LO)}");
ml1J_L300->SetStats(0);
ml1J_L300->Rebin(50);
ml1J_L300->GetXaxis()->SetRangeUser(0,1400);
ml1J_L300->GetYaxis()->SetRangeUser(0,80000);
ml1J_L300->GetXaxis()->SetTitle("m(l_{1}J) [GeV]");
ml1J_L300->SetLineColor(kRed);
ml1J_L300->SetLineWidth(3);
ml1J_L300->SetLineStyle(7);
ml1J_L300->Draw("hist");
ml1J_L600->Scale(ml1J_L300->GetEntries()/ml1J_L600->Integral());
ml1J_L600->Rebin(50);
ml1J_L600->SetLineColor(kGreen+1);
ml1J_L600->SetLineWidth(3);
ml1J_L600->SetLineStyle(7);
ml1J_L600->Draw("same hist");
ml1J_L1000->Scale(ml1J_L300->GetEntries()/ml1J_L1000->Integral());
ml1J_L1000->Rebin(50);
...
ml1J_N300->Scale(ml1J_L300->GetEntries()/ml1J_N300->Integral());
ml1J_N300->Rebin(50);
ml1J_N300->SetLineColor(kRed);
ml1J_N300->SetLineWidth(2);
ml1J_N300->Draw("same hist");
ml1J_N600->Scale(ml1J_L300->GetEntries()/ml1J_N600->Integral());
ml1J_N600->Rebin(50);
ml1J_N600->SetLineColor(kGreen+1);
ml1J_N600->SetLineWidth(2);
ml1J_N600->Draw("same hist");
ml1J_N1000->Scale(ml1J_L300->GetEntries()/ml1J_N1000->Integral());
ml1J_N1000->Rebin(50);
...
ml1J_legend->AddEntry(ml1J_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
ml1J_legend->AddEntry(ml1J_L300,"#scale[0.9]{LO}","l");
ml1J_legend->AddEntry(ml1J_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
ml1J_legend->AddEntry(ml1J_L600,"#scale[0.9]{LO}","l");
ml1J_legend->AddEntry(ml1J_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
ml2J_L300->SetTitle("m(l_{2}J) #scale[0.8]{(NLO vs LO)}");
ml2J_L300->SetStats(0);
ml2J_L300->Rebin(50);
ml2J_L300->GetXaxis()->SetRangeUser(0,1400);
ml2J_L300->GetYaxis()->SetRangeUser(0,25000);
ml2J_L300->GetXaxis()->SetTitle("m(l_{2}J) [GeV]");
ml2J_L300->SetLineColor(kRed);
ml2J_L300->SetLineWidth(3);
ml2J_L300->SetLineStyle(7);
ml2J_L300->Draw("hist");
ml2J_L600->Scale(ml2J_L300->GetEntries()/ml2J_L600->Integral());
ml2J_L600->Rebin(50);
ml2J_L600->SetLineColor(kGreen+1);
ml2J_L600->SetLineWidth(3);
ml2J_L600->SetLineStyle(7);
ml2J_L600->Draw("same hist");
ml2J_L1000->Scale(ml2J_L300->GetEntries()/ml2J_L1000->Integral());
ml2J_L1000->Rebin(50);
...
ml2J_N300->Scale(ml2J_L300->GetEntries()/ml2J_N300->Integral());
ml2J_N300->Rebin(50);
ml2J_N300->SetLineColor(kRed);
ml2J_N300->SetLineWidth(2);
ml2J_N300->Draw("same hist");
ml2J_N600->Scale(ml2J_L300->GetEntries()/ml2J_N600->Integral());
ml2J_N600->Rebin(50);
ml2J_N600->SetLineColor(kGreen+1);
ml2J_N600->SetLineWidth(2);
ml2J_N600->Draw("same hist");
ml2J_N1000->Scale(ml2J_L300->GetEntries()/ml2J_N1000->Integral());
ml2J_N1000->Rebin(50);
...
ml2J_legend->AddEntry(ml2J_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
ml2J_legend->AddEntry(ml2J_L300,"#scale[0.9]{LO}","l");
ml2J_legend->AddEntry(ml2J_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
ml2J_legend->AddEntry(ml2J_L600,"#scale[0.9]{LO}","l");
ml2J_legend->AddEntry(ml2J_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
hardqpt_L300->SetTitle("forward parton pt #scale[0.8]{(NLO vs LO)}");
hardqpt_L300->SetStats(0);
hardqpt_L300->Rebin(20);
hardqpt_L300->GetXaxis()->SetRangeUser(0,400);
hardqpt_L300->GetYaxis()->SetRangeUser(0,25000);
hardqpt_L300->GetXaxis()->SetTitle("forward parton p_{T} [GeV]");
hardqpt_L300->SetLineColor(kRed);
hardqpt_L300->SetLineWidth(3);
hardqpt_L300->SetLineStyle(7);
hardqpt_L300->Draw("hist");
hardqpt_L600->Scale(hardqpt_L300->GetEntries()/hardqpt_L600->Integral());
hardqpt_L600->Rebin(20);
hardqpt_L600->SetLineColor(kGreen+1);
hardqpt_L600->SetLineWidth(3);
hardqpt_L600->SetLineStyle(7);
hardqpt_L600->Draw("same hist");
hardqpt_L1000->Scale(hardqpt_L300->GetEntries()/hardqpt_L1000->Integral());
hardqpt_L1000->Rebin(20);
hardqpt_L1000->SetLineColor(kBlue);
hardqpt_L1000->SetLineWidth(3);
hardqpt_L1000->SetLineStyle(7);
hardqpt_L1000->Draw("same hist");
hardqpt_N300->SetStats(0);
hardqpt_N300->Scale(hardqpt_L300->GetEntries()/hardqpt_N300->Integral());
hardqpt_N300->Rebin(20);
hardqpt_N300->SetLineColor(kRed);
hardqpt_N300->SetLineWidth(2);
hardqpt_N300->Draw("same hist");
hardqpt_N600->Scale(hardqpt_L300->GetEntries()/hardqpt_N600->Integral());
hardqpt_N600->Rebin(20);
hardqpt_N600->SetLineColor(kGreen+1);
hardqpt_N600->SetLineWidth(2);
hardqpt_N600->Draw("same hist");
hardqpt_N1000->Scale(hardqpt_L300->GetEntries()/hardqpt_N1000->Integral());
hardqpt_N1000->Rebin(20);
hardqpt_N1000->SetLineColor(kBlue);
hardqpt_N1000->SetLineWidth(2);
hardqpt_N1000->Draw("same hist");

double hardqptdiff_300 = 100*(hardqpt_N300->GetMean()-hardqpt_L300->GetMean())/hardqpt_L300->GetMean();
TString hardqptdiff_300_t = Form("%f",hardqptdiff_300);
double hardqptdiff_600 = 100*(hardqpt_N600->GetMean()-hardqpt_L600->GetMean())/hardqpt_L600->GetMean();
TString hardqptdiff_600_t = Form("%f",hardqptdiff_600);
double hardqptdiff_1000 = 100*(hardqpt_N1000->GetMean()-hardqpt_L1000->GetMean())/hardqpt_L1000->GetMean();
TString hardqptdiff_1000_t = Form("%f",hardqptdiff_1000);
TLegend* hardqpt_legend = new TLegend(0.62,0.65,0.9,0.9);
hardqpt_legend->AddEntry(hardqpt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
hardqpt_legend->AddEntry(hardqpt_L300,"#scale[0.9]{LO}","l");
hardqpt_legend->AddEntry((TObject*)0,"#bf{mean p_{T}} diff : "+hardqptdiff_300_t+"%","");
hardqpt_legend->AddEntry(hardqpt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
hardqpt_legend->AddEntry(hardqpt_L600,"#scale[0.9]{LO}","l");
hardqpt_legend->AddEntry((TObject*)0,"diff : "+hardqptdiff_600_t+"%","");
hardqpt_legend->AddEntry(hardqpt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
hardqpt_legend->AddEntry(hardqpt_L1000,"#scale[0.9]{LO}","l");
hardqpt_legend->AddEntry((TObject*)0,"diff : "+hardqptdiff_1000_t+"%","");
hardqpt_legend->Draw();
}
...
hardqeta_L300->SetTitle("forward parton #eta #scale[0.8]{(NLO vs LO)}");
hardqeta_L300->SetStats(0);
hardqeta_L300->Rebin(2);
hardqeta_L300->GetYaxis()->SetRangeUser(0,10000);
hardqeta_L300->GetXaxis()->SetTitle("forward parton #eta");
hardqeta_L300->SetLineColor(kRed);
hardqeta_L300->SetLineWidth(3);
hardqeta_L300->SetLineStyle(7);
hardqeta_L300->Draw("hist");
hardqeta_L600->Scale(hardqeta_L300->GetEntries()/hardqeta_L600->Integral());
hardqeta_L600->Rebin(2);
hardqeta_L600->SetLineColor(kGreen+1);
hardqeta_L600->SetLineWidth(3);
hardqeta_L600->SetLineStyle(7);
hardqeta_L600->Draw("same hist");
hardqeta_L1000->Scale(hardqeta_L300->GetEntries()/hardqeta_L1000->Integral());
hardqeta_L1000->Rebin(2);
hardqeta_L1000->SetLineColor(kBlue);
hardqeta_L1000->SetLineWidth(3);
hardqeta_L1000->SetLineStyle(7);
hardqeta_L1000->Draw("same hist");
hardqeta_N300->SetStats(0);
hardqeta_N300->Scale(hardqeta_L300->GetEntries()/hardqeta_N300->Integral());
hardqeta_N300->Rebin(2);
hardqeta_N300->SetLineColor(kRed);
hardqeta_N300->SetLineWidth(2);
hardqeta_N300->Draw("same hist");
hardqeta_N600->Scale(hardqeta_L300->GetEntries()/hardqeta_N600->Integral());
hardqeta_N600->Rebin(2);
hardqeta_N600->SetLineColor(kGreen+1);
hardqeta_N600->SetLineWidth(2);
hardqeta_N600->Draw("same hist");
hardqeta_N1000->Scale(hardqeta_L300->GetEntries()/hardqeta_N1000->Integral());
...
hardqeta_legend->AddEntry(hardqeta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
hardqeta_legend->AddEntry(hardqeta_L300,"#scale[0.9]{LO}","l");
hardqeta_legend->AddEntry(hardqeta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
hardqeta_legend->AddEntry(hardqeta_L600,"#scale[0.9]{LO}","l");
hardqeta_legend->AddEntry(hardqeta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
hardqeta_legend->AddEntry(hardqeta_L1000,"#scale[0.9]{LO}","l");
...
Wq1pt_N300->Scale(Wq1pt_L300->GetEntries()/Wq1pt_N300->Integral());
Wq1pt_N300->Rebin(20);
Wq1pt_N300->SetLineColor(kRed);
Wq1pt_N300->SetLineWidth(2);
Wq1pt_N300->Draw("same hist");
Wq1pt_N600->Scale(Wq1pt_L300->GetEntries()/Wq1pt_N600->Integral());
Wq1pt_N600->Rebin(20);
Wq1pt_N600->SetLineColor(kGreen+1);
Wq1pt_N600->SetLineWidth(2);
Wq1pt_N600->Draw("same hist");
Wq1pt_N1000->Scale(Wq1pt_L300->GetEntries()/Wq1pt_N1000->Integral());
Wq1pt_N1000->Rebin(20);
Wq1pt_N1000->SetLineColor(kBlue);
Wq1pt_N1000->SetLineWidth(2);
Wq1pt_N1000->Draw("same hist");

double Wq1ptdiff_300 = 100*(Wq1pt_N300->GetMean()-Wq1pt_L300->GetMean())/Wq1pt_L300->GetMean();
TString Wq1ptdiff_300_t = Form("%f",Wq1ptdiff_300);
double Wq1ptdiff_600 = 100*(Wq1pt_N600->GetMean()-Wq1pt_L600->GetMean())/Wq1pt_L600->GetMean();
TString Wq1ptdiff_600_t = Form("%f",Wq1ptdiff_600);
double Wq1ptdiff_1000 = 100*(Wq1pt_N1000->GetMean()-Wq1pt_L1000->GetMean())/Wq1pt_L1000->GetMean();
TString Wq1ptdiff_1000_t = Form("%f",Wq1ptdiff_1000);
TLegend* Wq1pt_legend = new TLegend(0.62,0.65,0.9,0.9);
Wq1pt_legend->AddEntry(Wq1pt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Wq1pt_legend->AddEntry(Wq1pt_L300,"#scale[0.9]{LO}","l");
Wq1pt_legend->AddEntry((TObject*)0,"#bf{mean p_{T}} diff : "+Wq1ptdiff_300_t+"%","");
Wq1pt_legend->AddEntry(Wq1pt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Wq1pt_legend->AddEntry(Wq1pt_L600,"#scale[0.9]{LO}","l");
Wq1pt_legend->AddEntry((TObject*)0,"diff : "+Wq1ptdiff_600_t+"%","");
Wq1pt_legend->AddEntry(Wq1pt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
Wq1pt_legend->AddEntry(Wq1pt_L1000,"#scale[0.9]{LO}","l");
Wq1pt_legend->AddEntry((TObject*)0,"diff : "+Wq1ptdiff_1000_t+"%","");
Wq1pt_legend->Draw();
}
...
Wq1eta_L300->SetTitle("q_{W,1} #eta #scale[0.8]{(NLO vs LO)}");
Wq1eta_L300->SetStats(0);
Wq1eta_L300->Rebin(2);
Wq1eta_L300->GetYaxis()->SetRangeUser(0,15000);
Wq1eta_L300->GetXaxis()->SetTitle("q_{W,1} #eta");
Wq1eta_L300->SetLineColor(kRed);
Wq1eta_L300->SetLineWidth(3);
Wq1eta_L300->SetLineStyle(7);
Wq1eta_L300->Draw("hist");
Wq1eta_L600->Scale(Wq1eta_L300->GetEntries()/Wq1eta_L600->Integral());
Wq1eta_L600->Rebin(2);
Wq1eta_L600->SetLineColor(kGreen+1);
Wq1eta_L600->SetLineWidth(3);
Wq1eta_L600->SetLineStyle(7);
Wq1eta_L600->Draw("same hist");
Wq1eta_L1000->Scale(Wq1eta_L300->GetEntries()/Wq1eta_L1000->Integral());
...
Wq1eta_N300->Scale(Wq1eta_L300->GetEntries()/Wq1eta_N300->Integral());
Wq1eta_N300->Rebin(2);
Wq1eta_N300->SetLineColor(kRed);
Wq1eta_N300->SetLineWidth(2);
Wq1eta_N300->Draw("same hist");
Wq1eta_N600->Scale(Wq1eta_L300->GetEntries()/Wq1eta_N600->Integral());
Wq1eta_N600->Rebin(2);
Wq1eta_N600->SetLineColor(kGreen+1);
Wq1eta_N600->SetLineWidth(2);
Wq1eta_N600->Draw("same hist");
Wq1eta_N1000->Scale(Wq1eta_L300->GetEntries()/Wq1eta_N1000->Integral());
...
Wq1eta_legend->AddEntry(Wq1eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Wq1eta_legend->AddEntry(Wq1eta_L300,"#scale[0.9]{LO}","l");
Wq1eta_legend->AddEntry(Wq1eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Wq1eta_legend->AddEntry(Wq1eta_L600,"#scale[0.9]{LO}","l");
Wq1eta_legend->AddEntry(Wq1eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
Wq2pt_N300->Scale(Wq2pt_L300->GetEntries()/Wq2pt_N300->Integral());
Wq2pt_N300->Rebin(10);
Wq2pt_N300->SetLineColor(kRed);
Wq2pt_N300->SetLineWidth(2);
Wq2pt_N300->Draw("same hist");
Wq2pt_N600->Scale(Wq2pt_L300->GetEntries()/Wq2pt_N600->Integral());
Wq2pt_N600->Rebin(10);
Wq2pt_N600->SetLineColor(kGreen+1);
Wq2pt_N600->SetLineWidth(2);
Wq2pt_N600->Draw("same hist");
Wq2pt_N1000->Scale(Wq2pt_L300->GetEntries()/Wq2pt_N1000->Integral());
Wq2pt_N1000->Rebin(10);
Wq2pt_N1000->SetLineColor(kBlue);
Wq2pt_N1000->SetLineWidth(2);
Wq2pt_N1000->Draw("same hist");

double Wq2ptdiff_300 = 100*(Wq2pt_N300->GetMean()-Wq2pt_L300->GetMean())/Wq2pt_L300->GetMean();
TString Wq2ptdiff_300_t = Form("%f",Wq2ptdiff_300);
double Wq2ptdiff_600 = 100*(Wq2pt_N600->GetMean()-Wq2pt_L600->GetMean())/Wq2pt_L600->GetMean();
TString Wq2ptdiff_600_t = Form("%f",Wq2ptdiff_600);
double Wq2ptdiff_1000 = 100*(Wq2pt_N1000->GetMean()-Wq2pt_L1000->GetMean())/Wq2pt_L1000->GetMean();
TString Wq2ptdiff_1000_t = Form("%f",Wq2ptdiff_1000);
TLegend* Wq2pt_legend = new TLegend(0.62,0.65,0.9,0.9);
Wq2pt_legend->AddEntry(Wq2pt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Wq2pt_legend->AddEntry(Wq2pt_L300,"#scale[0.9]{LO}","l");
Wq2pt_legend->AddEntry((TObject*)0,"#bf{mean p_{T}} diff : "+Wq2ptdiff_300_t+"%","");
Wq2pt_legend->AddEntry(Wq2pt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Wq2pt_legend->AddEntry(Wq2pt_L600,"#scale[0.9]{LO}","l");
Wq2pt_legend->AddEntry((TObject*)0,"diff : "+Wq2ptdiff_600_t+"%","");
Wq2pt_legend->AddEntry(Wq2pt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
Wq2pt_legend->AddEntry(Wq2pt_L1000,"#scale[0.9]{LO}","l");
Wq2pt_legend->AddEntry((TObject*)0,"diff : "+Wq2ptdiff_1000_t+"%","");
Wq2pt_legend->Draw();
}
...
Wq2eta_L300->SetTitle("q_{W,2} #eta #scale[0.8]{(NLO vs LO)}");
Wq2eta_L300->SetStats(0);
Wq2eta_L300->Rebin(2);
Wq2eta_L300->GetYaxis()->SetRangeUser(0,15000);
Wq2eta_L300->GetXaxis()->SetTitle("q_{W,2} #eta");
Wq2eta_L300->SetLineColor(kRed);
Wq2eta_L300->SetLineWidth(3);
Wq2eta_L300->SetLineStyle(7);
Wq2eta_L300->Draw("hist");
Wq2eta_L600->Scale(Wq2eta_L300->GetEntries()/Wq2eta_L600->Integral());
Wq2eta_L600->Rebin(2);
Wq2eta_L600->SetLineColor(kGreen+1);
Wq2eta_L600->SetLineWidth(3);
Wq2eta_L600->SetLineStyle(7);
Wq2eta_L600->Draw("same hist");
Wq2eta_L1000->Scale(Wq2eta_L300->GetEntries()/Wq2eta_L1000->Integral());
...
Wq2eta_N300->Scale(Wq2eta_L300->GetEntries()/Wq2eta_N300->Integral());
Wq2eta_N300->Rebin(2);
Wq2eta_N300->SetLineColor(kRed);
Wq2eta_N300->SetLineWidth(2);
Wq2eta_N300->Draw("same hist");
Wq2eta_N600->Scale(Wq2eta_L300->GetEntries()/Wq2eta_N600->Integral());
Wq2eta_N600->Rebin(2);
Wq2eta_N600->SetLineColor(kGreen+1);
Wq2eta_N600->SetLineWidth(2);
Wq2eta_N600->Draw("same hist");
Wq2eta_N1000->Scale(Wq2eta_L300->GetEntries()/Wq2eta_N1000->Integral());
...
Wq2eta_legend->AddEntry(Wq2eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
Wq2eta_legend->AddEntry(Wq2eta_L300,"#scale[0.9]{LO}","l");
Wq2eta_legend->AddEntry(Wq2eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
Wq2eta_legend->AddEntry(Wq2eta_L600,"#scale[0.9]{LO}","l");
Wq2eta_legend->AddEntry(Wq2eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
dRjj_N300->Scale(dRjj_L300->GetEntries()/dRjj_N300->Integral());
dRjj_N300->Rebin(2);
dRjj_N300->SetLineColor(kRed);
dRjj_N300->SetLineWidth(2);
dRjj_N300->Draw("same hist");
dRjj_N600->Scale(dRjj_L300->GetEntries()/dRjj_N600->Integral());
dRjj_N600->Rebin(2);
dRjj_N600->SetLineColor(kGreen+1);
dRjj_N600->SetLineWidth(2);
dRjj_N600->Draw("same hist");
dRjj_N1000->Scale(dRjj_L300->GetEntries()/dRjj_N1000->Integral());
dRjj_N1000->Rebin(2);
...
dRjj_legend->AddEntry(dRjj_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRjj_legend->AddEntry(dRjj_L300,"#scale[0.9]{LO}","l");
dRjj_legend->AddEntry(dRjj_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRjj_legend->AddEntry(dRjj_L600,"#scale[0.9]{LO}","l");
dRjj_legend->AddEntry(dRjj_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
dRqq_N300->Scale(dRqq_L300->GetEntries()/dRqq_N300->Integral());
dRqq_N300->Rebin(2);
dRqq_N300->SetLineColor(kRed);
dRqq_N300->SetLineWidth(2);
dRqq_N300->Draw("same hist");
dRqq_N600->Scale(dRqq_L300->GetEntries()/dRqq_N600->Integral());
dRqq_N600->Rebin(2);
dRqq_N600->SetLineColor(kGreen+1);
dRqq_N600->SetLineWidth(2);
dRqq_N600->Draw("same hist");
dRqq_N1000->Scale(dRqq_L300->GetEntries()/dRqq_N1000->Integral());
dRqq_N1000->Rebin(2);
...
dRqq_legend->AddEntry(dRqq_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRqq_legend->AddEntry(dRqq_L300,"#scale[0.9]{LO}","l");
dRqq_legend->AddEntry(dRqq_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRqq_legend->AddEntry(dRqq_L600,"#scale[0.9]{LO}","l");
dRqq_legend->AddEntry(dRqq_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W2pt_L300->SetTitle("W2 pt #scale[0.8]{(NLO vs LO)}");
...
W2pt_legend->AddEntry(W2pt_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W2pt_legend->AddEntry(W2pt_L300,"#scale[0.9]{LO}","l");
W2pt_legend->AddEntry(W2pt_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W2pt_legend->AddEntry(W2pt_L600,"#scale[0.9]{LO}","l");
W2pt_legend->AddEntry(W2pt_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W2eta_L300->SetTitle("W2 eta #scale[0.8]{(NLO vs LO)}");
...
W2eta_legend->AddEntry(W2eta_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W2eta_legend->AddEntry(W2eta_L300,"#scale[0.9]{LO}","l");
W2eta_legend->AddEntry(W2eta_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W2eta_legend->AddEntry(W2eta_L600,"#scale[0.9]{LO}","l");
W2eta_legend->AddEntry(W2eta_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
W2mass_L300->SetTitle("W2 mass #scale[0.8]{(NLO vs LO)}");
...
W2mass_legend->AddEntry(W2mass_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
W2mass_legend->AddEntry(W2mass_L300,"#scale[0.9]{LO}","l");
W2mass_legend->AddEntry(W2mass_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
W2mass_legend->AddEntry(W2mass_L600,"#scale[0.9]{LO}","l");
W2mass_legend->AddEntry(W2mass_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
MET_L300->SetTitle("MET #scale[0.8]{(NLO vs LO)}");
MET_L300->SetStats(0);
...
MET_legend->AddEntry(MET_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
MET_legend->AddEntry(MET_L300,"#scale[0.9]{LO}","l");
MET_legend->AddEntry(MET_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
MET_legend->AddEntry(MET_L600,"#scale[0.9]{LO}","l");
MET_legend->AddEntry(MET_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
...
ml1Wq1_L300->SetTitle("m(l_{1}q_{W,1}) #scale[0.8]{(NLO vs LO)}");
ml1Wq1_L300->SetStats(0);
ml1Wq1_L300->Rebin(50);
ml1Wq1_L300->GetXaxis()->SetRangeUser(0,1400);
ml1Wq1_L300->GetYaxis()->SetRangeUser(0,80000);
ml1Wq1_L300->GetXaxis()->SetTitle("m(l_{1}q_{W,1})");
ml1Wq1_L300->SetLineColor(kRed);
ml1Wq1_L300->SetLineWidth(3);
ml1Wq1_L300->SetLineStyle(7);
ml1Wq1_L300->Draw("hist");
ml1Wq1_L600->Scale(ml1Wq1_L300->GetEntries()/ml1Wq1_L600->Integral());
ml1Wq1_L600->Rebin(50);
ml1Wq1_L600->SetLineColor(kGreen+1);
ml1Wq1_L600->SetLineWidth(3);
ml1Wq1_L600->SetLineStyle(7);
ml1Wq1_L600->Draw("same hist");
ml1Wq1_L1000->Scale(ml1Wq1_L300->GetEntries()/ml1Wq1_L1000->Integral());
ml1Wq1_L1000->Rebin(50);
ml1Wq1_L1000->SetLineColor(kBlue);
ml1Wq1_L1000->SetLineWidth(3);
ml1Wq1_L1000->SetLineStyle(7);
ml1Wq1_L1000->Draw("same hist");
ml1Wq1_N300->SetStats(0);
ml1Wq1_N300->Scale(ml1Wq1_L300->GetEntries()/ml1Wq1_N300->Integral());
ml1Wq1_N300->Rebin(50);
ml1Wq1_N300->SetLineColor(kRed);
ml1Wq1_N300->SetLineWidth(2);
ml1Wq1_N300->Draw("same hist");
ml1Wq1_N600->Scale(ml1Wq1_L300->GetEntries()/ml1Wq1_N600->Integral());
ml1Wq1_N600->Rebin(50);
ml1Wq1_N600->SetLineColor(kGreen+1);
ml1Wq1_N600->SetLineWidth(2);
ml1Wq1_N600->Draw("same hist");
ml1Wq1_N1000->Scale(ml1Wq1_L300->GetEntries()/ml1Wq1_N1000->Integral());
ml1Wq1_N1000->Rebin(50);
ml1Wq1_N1000->SetLineColor(kBlue);
ml1Wq1_N1000->SetLineWidth(2);
ml1Wq1_N1000->Draw("same hist");

TLegend* ml1Wq1_legend = new TLegend(0.62,0.75,0.9,0.9);
ml1Wq1_legend->AddEntry(ml1Wq1_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
ml1Wq1_legend->AddEntry(ml1Wq1_L300,"#scale[0.9]{LO}","l");
ml1Wq1_legend->AddEntry(ml1Wq1_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
ml1Wq1_legend->AddEntry(ml1Wq1_L600,"#scale[0.9]{LO}","l");
ml1Wq1_legend->AddEntry(ml1Wq1_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
ml1Wq1_legend->AddEntry(ml1Wq1_L1000,"#scale[0.9]{LO}","l");
ml1Wq1_legend->Draw();
}
...
dRWJ_L300->SetTitle("dR(WJ) #scale[0.8]{(NLO vs LO)}");
dRWJ_L300->SetStats(0);
dRWJ_L300->Rebin(2);
dRWJ_L300->GetYaxis()->SetRangeUser(0,90000);
dRWJ_L300->GetXaxis()->SetTitle("#DeltaR(WJ)");
dRWJ_L300->SetLineColor(kRed);
dRWJ_L300->SetLineWidth(3);
dRWJ_L300->SetLineStyle(7);
dRWJ_L300->Draw("hist");
dRWJ_L600->Scale(dRWJ_L300->GetEntries()/dRWJ_L600->Integral());
dRWJ_L600->Rebin(2);
dRWJ_L600->SetLineColor(kGreen+1);
dRWJ_L600->SetLineWidth(3);
dRWJ_L600->SetLineStyle(7);
dRWJ_L600->Draw("same hist");
dRWJ_L1000->Scale(dRWJ_L300->GetEntries()/dRWJ_L1000->Integral());
dRWJ_L1000->Rebin(2);
dRWJ_L1000->SetLineColor(kBlue);
dRWJ_L1000->SetLineWidth(3);
dRWJ_L1000->SetLineStyle(7);
dRWJ_L1000->Draw("same hist");
dRWJ_N300->SetStats(0);
dRWJ_N300->Scale(dRWJ_L300->GetEntries()/dRWJ_N300->Integral());
dRWJ_N300->Rebin(2);
dRWJ_N300->SetLineColor(kRed);
dRWJ_N300->SetLineWidth(2);
dRWJ_N300->Draw("same hist");
dRWJ_N600->Scale(dRWJ_L300->GetEntries()/dRWJ_N600->Integral());
dRWJ_N600->Rebin(2);
dRWJ_N600->SetLineColor(kGreen+1);
dRWJ_N600->SetLineWidth(2);
dRWJ_N600->Draw("same hist");
dRWJ_N1000->Scale(dRWJ_L300->GetEntries()/dRWJ_N1000->Integral());
dRWJ_N1000->Rebin(2);
dRWJ_N1000->SetLineColor(kBlue);
dRWJ_N1000->SetLineWidth(2);
dRWJ_N1000->Draw("same hist");

TLegend* dRWJ_legend = new TLegend(0.62,0.75,0.9,0.9);
dRWJ_legend->AddEntry(dRWJ_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRWJ_legend->AddEntry(dRWJ_L300,"#scale[0.9]{LO}","l");
dRWJ_legend->AddEntry(dRWJ_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRWJ_legend->AddEntry(dRWJ_L600,"#scale[0.9]{LO}","l");
dRWJ_legend->AddEntry(dRWJ_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRWJ_legend->AddEntry(dRWJ_L1000,"#scale[0.9]{LO}","l");
dRWJ_legend->Draw();
}
...
dRq1J_L300->SetTitle("dR(q_{W,1}J) #scale[0.8]{(NLO vs LO)}");
dRq1J_L300->SetStats(0);
dRq1J_L300->Rebin(2);
dRq1J_L300->GetYaxis()->SetRangeUser(0,90000);
dRq1J_L300->GetXaxis()->SetTitle("#DeltaR(q_{W,1}J)");
dRq1J_L300->SetLineColor(kRed);
dRq1J_L300->SetLineWidth(3);
dRq1J_L300->SetLineStyle(7);
dRq1J_L300->Draw("hist");
dRq1J_L600->Scale(dRq1J_L300->GetEntries()/dRq1J_L600->Integral());
dRq1J_L600->Rebin(2);
dRq1J_L600->SetLineColor(kGreen+1);
dRq1J_L600->SetLineWidth(3);
dRq1J_L600->SetLineStyle(7);
dRq1J_L600->Draw("same hist");
dRq1J_L1000->Scale(dRq1J_L300->GetEntries()/dRq1J_L1000->Integral());
dRq1J_L1000->Rebin(2);
dRq1J_L1000->SetLineColor(kBlue);
dRq1J_L1000->SetLineWidth(3);
dRq1J_L1000->SetLineStyle(7);
dRq1J_L1000->Draw("same hist");
dRq1J_N300->SetStats(0);
dRq1J_N300->Scale(dRq1J_L300->GetEntries()/dRq1J_N300->Integral());
dRq1J_N300->Rebin(2);
dRq1J_N300->SetLineColor(kRed);
dRq1J_N300->SetLineWidth(2);
dRq1J_N300->Draw("same hist");
dRq1J_N600->Scale(dRq1J_L300->GetEntries()/dRq1J_N600->Integral());
dRq1J_N600->Rebin(2);
dRq1J_N600->SetLineColor(kGreen+1);
dRq1J_N600->SetLineWidth(2);
dRq1J_N600->Draw("same hist");
dRq1J_N1000->Scale(dRq1J_L300->GetEntries()/dRq1J_N1000->Integral());
dRq1J_N1000->Rebin(2);
dRq1J_N1000->SetLineColor(kBlue);
dRq1J_N1000->SetLineWidth(2);
dRq1J_N1000->Draw("same hist");

TLegend* dRq1J_legend = new TLegend(0.62,0.75,0.9,0.9);
dRq1J_legend->AddEntry(dRq1J_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRq1J_legend->AddEntry(dRq1J_L300,"#scale[0.9]{LO}","l");
dRq1J_legend->AddEntry(dRq1J_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRq1J_legend->AddEntry(dRq1J_L600,"#scale[0.9]{LO}","l");
dRq1J_legend->AddEntry(dRq1J_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRq1J_legend->AddEntry(dRq1J_L1000,"#scale[0.9]{LO}","l");
dRq1J_legend->Draw();
}
...
dRq2J_L300->SetTitle("dR(q_{W,2}J) #scale[0.8]{(NLO vs LO)}");
dRq2J_L300->SetStats(0);
dRq2J_L300->Rebin(2);
dRq2J_L300->GetYaxis()->SetRangeUser(0,50000);
dRq2J_L300->GetXaxis()->SetTitle("#DeltaR(q_{W,2}J)");
dRq2J_L300->SetLineColor(kRed);
dRq2J_L300->SetLineWidth(3);
dRq2J_L300->SetLineStyle(7);
dRq2J_L300->Draw("hist");
dRq2J_L600->Scale(dRq2J_L300->GetEntries()/dRq2J_L600->Integral());
dRq2J_L600->Rebin(2);
dRq2J_L600->SetLineColor(kGreen+1);
dRq2J_L600->SetLineWidth(3);
dRq2J_L600->SetLineStyle(7);
dRq2J_L600->Draw("same hist");
dRq2J_L1000->Scale(dRq2J_L300->GetEntries()/dRq2J_L1000->Integral());
dRq2J_L1000->Rebin(2);
dRq2J_L1000->SetLineColor(kBlue);
dRq2J_L1000->SetLineWidth(3);
dRq2J_L1000->SetLineStyle(7);
dRq2J_L1000->Draw("same hist");
dRq2J_N300->SetStats(0);
dRq2J_N300->Scale(dRq2J_L300->GetEntries()/dRq2J_N300->Integral());
dRq2J_N300->Rebin(2);
dRq2J_N300->SetLineColor(kRed);
dRq2J_N300->SetLineWidth(2);
dRq2J_N300->Draw("same hist");
dRq2J_N600->Scale(dRq2J_L300->GetEntries()/dRq2J_N600->Integral());
dRq2J_N600->Rebin(2);
dRq2J_N600->SetLineColor(kGreen+1);
dRq2J_N600->SetLineWidth(2);
dRq2J_N600->Draw("same hist");
dRq2J_N1000->Scale(dRq2J_L300->GetEntries()/dRq2J_N1000->Integral());
dRq2J_N1000->Rebin(2);
dRq2J_N1000->SetLineColor(kBlue);
dRq2J_N1000->SetLineWidth(2);
dRq2J_N1000->Draw("same hist");

TLegend* dRq2J_legend = new TLegend(0.62,0.75,0.9,0.9);
dRq2J_legend->AddEntry(dRq2J_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRq2J_legend->AddEntry(dRq2J_L300,"#scale[0.9]{LO}","l");
dRq2J_legend->AddEntry(dRq2J_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRq2J_legend->AddEntry(dRq2J_L600,"#scale[0.9]{LO}","l");
dRq2J_legend->AddEntry(dRq2J_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRq2J_legend->AddEntry(dRq2J_L1000,"#scale[0.9]{LO}","l");
dRq2J_legend->Draw();
}
...
dRq1forward_L300->SetTitle("dR(q_{W,1}q_{fwd}) #scale[0.8]{(NLO vs LO)}");
dRq1forward_L300->SetStats(0);
dRq1forward_L300->Rebin(2);
dRq1forward_L300->GetYaxis()->SetRangeUser(0,50000);
dRq1forward_L300->GetXaxis()->SetTitle("#DeltaR(q_{W,1}q_{fwd})");
dRq1forward_L300->SetLineColor(kRed);
dRq1forward_L300->SetLineWidth(3);
dRq1forward_L300->SetLineStyle(7);
dRq1forward_L300->Draw("hist");
dRq1forward_L600->Scale(dRq1forward_L300->GetEntries()/dRq1forward_L600->Integral());
dRq1forward_L600->Rebin(2);
dRq1forward_L600->SetLineColor(kGreen+1);
dRq1forward_L600->SetLineWidth(3);
dRq1forward_L600->SetLineStyle(7);
dRq1forward_L600->Draw("same hist");
dRq1forward_L1000->Scale(dRq1forward_L300->GetEntries()/dRq1forward_L1000->Integral());
dRq1forward_L1000->Rebin(2);
dRq1forward_L1000->SetLineColor(kBlue);
dRq1forward_L1000->SetLineWidth(3);
dRq1forward_L1000->SetLineStyle(7);
dRq1forward_L1000->Draw("same hist");
dRq1forward_N300->SetStats(0);
dRq1forward_N300->Scale(dRq1forward_L300->GetEntries()/dRq1forward_N300->Integral());
dRq1forward_N300->Rebin(2);
dRq1forward_N300->SetLineColor(kRed);
dRq1forward_N300->SetLineWidth(2);
dRq1forward_N300->Draw("same hist");
dRq1forward_N600->Scale(dRq1forward_L300->GetEntries()/dRq1forward_N600->Integral());
dRq1forward_N600->Rebin(2);
dRq1forward_N600->SetLineColor(kGreen+1);
dRq1forward_N600->SetLineWidth(2);
dRq1forward_N600->Draw("same hist");
dRq1forward_N1000->Scale(dRq1forward_L300->GetEntries()/dRq1forward_N1000->Integral());
dRq1forward_N1000->Rebin(2);
dRq1forward_N1000->SetLineColor(kBlue);
dRq1forward_N1000->SetLineWidth(2);
dRq1forward_N1000->Draw("same hist");

TLegend* dRq1forward_legend = new TLegend(0.62,0.75,0.9,0.9);
dRq1forward_legend->AddEntry(dRq1forward_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRq1forward_legend->AddEntry(dRq1forward_L300,"#scale[0.9]{LO}","l");
dRq1forward_legend->AddEntry(dRq1forward_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRq1forward_legend->AddEntry(dRq1forward_L600,"#scale[0.9]{LO}","l");
dRq1forward_legend->AddEntry(dRq1forward_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRq1forward_legend->AddEntry(dRq1forward_L1000,"#scale[0.9]{LO}","l");
dRq1forward_legend->Draw();
}
...
dRq2forward_L300->SetTitle("dR(q_{W,2}q_{fwd}) #scale[0.8]{(NLO vs LO)}");
dRq2forward_L300->SetStats(0);
dRq2forward_L300->Rebin(2);
dRq2forward_L300->GetYaxis()->SetRangeUser(0,50000);
dRq2forward_L300->GetXaxis()->SetTitle("#DeltaR(q_{W,2}q_{fwd})");
dRq2forward_L300->SetLineColor(kRed);
dRq2forward_L300->SetLineWidth(3);
dRq2forward_L300->SetLineStyle(7);
dRq2forward_L300->Draw("hist");
dRq2forward_L600->Scale(dRq2forward_L300->GetEntries()/dRq2forward_L600->Integral());
dRq2forward_L600->Rebin(2);
dRq2forward_L600->SetLineColor(kGreen+1);
dRq2forward_L600->SetLineWidth(3);
dRq2forward_L600->SetLineStyle(7);
dRq2forward_L600->Draw("same hist");
dRq2forward_L1000->Scale(dRq2forward_L300->GetEntries()/dRq2forward_L1000->Integral());
dRq2forward_L1000->Rebin(2);
dRq2forward_L1000->SetLineColor(kBlue);
dRq2forward_L1000->SetLineWidth(3);
dRq2forward_L1000->SetLineStyle(7);
dRq2forward_L1000->Draw("same hist");
dRq2forward_N300->SetStats(0);
dRq2forward_N300->Scale(dRq2forward_L300->GetEntries()/dRq2forward_N300->Integral());
dRq2forward_N300->Rebin(2);
dRq2forward_N300->SetLineColor(kRed);
dRq2forward_N300->SetLineWidth(2);
dRq2forward_N300->Draw("same hist");
dRq2forward_N600->Scale(dRq2forward_L300->GetEntries()/dRq2forward_N600->Integral());
dRq2forward_N600->Rebin(2);
dRq2forward_N600->SetLineColor(kGreen+1);
dRq2forward_N600->SetLineWidth(2);
dRq2forward_N600->Draw("same hist");
dRq2forward_N1000->Scale(dRq2forward_L300->GetEntries()/dRq2forward_N1000->Integral());
dRq2forward_N1000->Rebin(2);
dRq2forward_N1000->SetLineColor(kBlue);
dRq2forward_N1000->SetLineWidth(2);
dRq2forward_N1000->Draw("same hist");

TLegend* dRq2forward_legend = new TLegend(0.62,0.75,0.9,0.9);
dRq2forward_legend->AddEntry(dRq2forward_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRq2forward_legend->AddEntry(dRq2forward_L300,"#scale[0.9]{LO}","l");
dRq2forward_legend->AddEntry(dRq2forward_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRq2forward_legend->AddEntry(dRq2forward_L600,"#scale[0.9]{LO}","l");
dRq2forward_legend->AddEntry(dRq2forward_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRq2forward_legend->AddEntry(dRq2forward_L1000,"#scale[0.9]{LO}","l");
dRq2forward_legend->Draw();
}
...
dRj2forward_L300->SetTitle("dR(j_{2}q_{fwd}) #scale[0.8]{(NLO vs LO)}");
dRj2forward_L300->SetStats(0);
dRj2forward_L300->Rebin(2);
dRj2forward_L300->GetYaxis()->SetRangeUser(0,50000);
dRj2forward_L300->GetXaxis()->SetTitle("#DeltaR(j_{2}q_{fwd})");
dRj2forward_L300->SetLineColor(kRed);
dRj2forward_L300->SetLineWidth(3);
dRj2forward_L300->SetLineStyle(7);
dRj2forward_L300->Draw("hist");
dRj2forward_L600->Scale(dRj2forward_L300->GetEntries()/dRj2forward_L600->Integral());
dRj2forward_L600->Rebin(2);
dRj2forward_L600->SetLineColor(kGreen+1);
dRj2forward_L600->SetLineWidth(3);
dRj2forward_L600->SetLineStyle(7);
dRj2forward_L600->Draw("same hist");
dRj2forward_L1000->Scale(dRj2forward_L300->GetEntries()/dRj2forward_L1000->Integral());
dRj2forward_L1000->Rebin(2);
dRj2forward_L1000->SetLineColor(kBlue);
dRj2forward_L1000->SetLineWidth(3);
dRj2forward_L1000->SetLineStyle(7);
dRj2forward_L1000->Draw("same hist");
dRj2forward_N300->SetStats(0);
dRj2forward_N300->Scale(dRj2forward_L300->GetEntries()/dRj2forward_N300->Integral());
dRj2forward_N300->Rebin(2);
dRj2forward_N300->SetLineColor(kRed);
dRj2forward_N300->SetLineWidth(2);
dRj2forward_N300->Draw("same hist");
dRj2forward_N600->Scale(dRj2forward_L300->GetEntries()/dRj2forward_N600->Integral());
dRj2forward_N600->Rebin(2);
dRj2forward_N600->SetLineColor(kGreen+1);
dRj2forward_N600->SetLineWidth(2);
dRj2forward_N600->Draw("same hist");
dRj2forward_N1000->Scale(dRj2forward_L300->GetEntries()/dRj2forward_N1000->Integral());
dRj2forward_N1000->Rebin(2);
dRj2forward_N1000->SetLineColor(kBlue);
dRj2forward_N1000->SetLineWidth(2);
dRj2forward_N1000->Draw("same hist");

TLegend* dRj2forward_legend = new TLegend(0.62,0.75,0.9,0.9);
dRj2forward_legend->AddEntry(dRj2forward_N300,"Tch #mu#mu m_{N}=300GeV, NLO","l");
dRj2forward_legend->AddEntry(dRj2forward_L300,"#scale[0.9]{LO}","l");
dRj2forward_legend->AddEntry(dRj2forward_N600,"Tch #mu#mu m_{N}=600GeV, NLO","l");
dRj2forward_legend->AddEntry(dRj2forward_L600,"#scale[0.9]{LO}","l");
dRj2forward_legend->AddEntry(dRj2forward_N1000,"Tch #mu#mu m_{N}=1000GeV, NLO","l");
dRj2forward_legend->AddEntry(dRj2forward_L1000,"#scale[0.9]{LO}","l");
dRj2forward_legend->Draw();
}
...
c1->SaveAs("Tch_kinematics/mlljj.png");
//c2->SaveAs("Tch_kinematics/ml1jj.png");
//c3->SaveAs("Tch_kinematics/ml2jj.png");
c4->SaveAs("Tch_kinematics/N_pt.png");
c5->SaveAs("Tch_kinematics/N_eta.png");
//c6->SaveAs("Tch_kinematics/N_energy.png");
c7->SaveAs("Tch_kinematics/Nl_pt.png");
c9->SaveAs("Tch_kinematics/Nl_eta.png");
//c10->SaveAs("Tch_kinematics/W1_pt.png");
//c11->SaveAs("Tch_kinematics/W1_eta.png");
//c12->SaveAs("Tch_kinematics/W1_mass.png");
//c13->SaveAs("Tch_kinematics/W1_energy.png");
c14->SaveAs("Tch_kinematics/gammal_pt.png");
c15->SaveAs("Tch_kinematics/gammal_eta.png");
c16->SaveAs("Tch_kinematics/j1_pt.png");
c17->SaveAs("Tch_kinematics/j1_eta.png");
c18->SaveAs("Tch_kinematics/j2_pt.png");
c19->SaveAs("Tch_kinematics/j2_eta.png");
c20->SaveAs("Tch_kinematics/fatjet_pt.png");
c21->SaveAs("Tch_kinematics/fatjet_eta.png");
c22->SaveAs("Tch_kinematics/fatjet_mass.png");
c23->SaveAs("Tch_kinematics/dijet_mass.png");
c24->SaveAs("Tch_kinematics/mllJ.png");
c25->SaveAs("Tch_kinematics/ml1J.png");
c26->SaveAs("Tch_kinematics/ml2J.png");
c27->SaveAs("Tch_kinematics/forward_parton_pt.png");
c28->SaveAs("Tch_kinematics/forward_parton_eta.png");
c29->SaveAs("Tch_kinematics/W_q1_pt.png");
c30->SaveAs("Tch_kinematics/W_q1_eta.png");
c31->SaveAs("Tch_kinematics/W_q2_pt.png");
c32->SaveAs("Tch_kinematics/W_q2_eta.png");
c33->SaveAs("Tch_kinematics/dRjj.png");
c34->SaveAs("Tch_kinematics/dRqq.png");
//c35->SaveAs("Tch_kinematics/W2_pt.png");
//c36->SaveAs("Tch_kinematics/W2_eta.png");
//c37->SaveAs("Tch_kinematics/W2_mass.png");
//c38->SaveAs("Tch_kinematics/MET.png");
c39->SaveAs("Tch_kinematics/ml1q1.png");
c40->SaveAs("Tch_kinematics/dRWJ.png");
c41->SaveAs("Tch_kinematics/dRq1J.png");
c42->SaveAs("Tch_kinematics/dRq2J.png");
c43->SaveAs("Tch_kinematics/dRq1forward.png");
c44->SaveAs("Tch_kinematics/dRq2forward.png");
c45->SaveAs("Tch_kinematics/dRj2forward.png");
