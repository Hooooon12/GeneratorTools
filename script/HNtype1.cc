...
void loop(TString infile,TString outfile){
  ...
  for(ev.toBegin();!ev.atEnd();++ev){
    ...
    if(gamma_l||HN_l){ 
      ...
      TLorentzVector* arr_jets=MakeTLorentzVectorArray(jets); 
      ...
      sort(arr_jets,arr_jets+jets.size(),PtCompare);
      ...
      FillHist("hard_W_eta",vec_hard_W.Eta(),1,50,-5,5);
      FillHist("last_W_m",vec_last_W.M(),1,70,50,120);
      FillHist("last_W_pt",vec_last_W.Pt(),1,1000,0,1000);
      FillHist("last_W_eta",vec_last_W.Eta(),1,50,-5,5);
      FillHist("dijet_m",vec_dijet.M(),1,2000,0,2000);
      ...
      FillHist("fatjet_pt",vec_fatjet.Pt(),1,1000,0,1000);
      ...
      FillHist("(l0+fatjet)_m",vec_l0_fatjet.M(),1,2000,0,2000);
      FillHist("(l0+fatjet)_pt",vec_l0_fatjet.Pt(),1,1000,0,1000);
      ...
      FillHist("(l0+dijet)_m",vec_l0_dijet.M(),1,2000,0,2000);
      FillHist("(l0+dijet)_pt",vec_l0_dijet.Pt(),1,1000,0,1000);
      FillHist("(l0+dijet)_eta",vec_l0_dijet.Eta(),1,50,-5,5);
      FillHist("(l1+dijet)_m",vec_l1_dijet.M(),1,2000,0,2000);
